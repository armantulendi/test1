package example.multi.connectTest.main;
...
@EnableJpaRepositories(
        basePackages = "example.multi.connectTest.repo.person", //указываем где у нас сущность
        entityManagerFactoryRef = "mainEntityManager", //менеджер сущностей
        transactionManagerRef = "mainTransactionManager") //транзакция
public class DatabaseThird {
    ...
    public LocalContainerEntityManagerFactoryBean thirdEntityManager() {
        ...
        em.setPersistenceUnitName("thirdUnitTest");
       em.setPackagesToScan("example.multi.connectTest.model.person");
