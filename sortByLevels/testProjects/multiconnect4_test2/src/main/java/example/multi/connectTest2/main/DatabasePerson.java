...
@EnableJpaRepositories(
        basePackages = "example.multi.connectTest2.repo.person",
...
//    private boolean formatSQL;
    @Value("${main.entitymanager.packages.to.scan}")
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManager() {
        ...
        em.setPackagesToScan("example.multi.connectTest2.model.person");
