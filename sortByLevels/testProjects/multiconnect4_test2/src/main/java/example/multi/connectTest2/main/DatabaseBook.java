package example.multi.connectTest2.main;
...
@EnableJpaRepositories(
        basePackages = "example.multi.connectTest2.repo.book",
...
//    private boolean formatSQL;
    @Value("${third.entitymanager.packages.to.scan}")
    ...
    public LocalContainerEntityManagerFactoryBean thirdEntityManager() {
        ...
        em.setPersistenceUnitName("thirdUnit");
       em.setPackagesToScan("example.multi.connectTest2.model.book");
